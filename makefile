...
${OUT}: ${OBJ}/noitcartbus.o ${OBJ}/noitacilpitlum.o ${OBJ}/yfilpmis.o ${OBJ}/noitidda.o ${OBJ}/noisivid.o ${OBJ}/niam.o
	${CC} ${CFLAGS} ${DEFFLAGS} ${LIB} -o ${OUT} ${OBJ}/noitcartbus.o ${OBJ}/noitacilpitlum.o ${OBJ}/yfilpmis.o ${OBJ}/noitidda.o ${OBJ}/noisivid.o ${OBJ}/niam.o ${LIBS}

${LIBOUT}: ${OBJ}/noitcartbus.o ${OBJ}/noitacilpitlum.o ${OBJ}/yfilpmis.o ${OBJ}/noitidda.o ${OBJ}/noisivid.o
	ar rcs ${LIBOUT} ${OBJ}/noitcartbus.o ${OBJ}/noitacilpitlum.o ${OBJ}/yfilpmis.o ${OBJ}/noitidda.o ${OBJ}/noisivid.o
